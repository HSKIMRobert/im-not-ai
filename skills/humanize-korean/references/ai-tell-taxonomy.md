...
- _quick: true · quick_pattern: "필요한/중요한 것은 ~이다" 분열문 · quick_fix: 주어-서술 직결로("필요한 것은 방향이다" → "방향이 필요하다")_
...
- _quick: true · quick_pattern: "(으)로 이어진다" 결산 · quick_fix: 인과 경로를 구체로 쓰거나 단문 단언으로_
...
- _quick: true · quick_pattern: 문장 말미 "~하는 이유다" 도치 결산 · quick_fix: 순방향 단언("그래서 ~다")으로, 문서당 1회 이하_
