...
assert_contains "$claude_output" "+ ln -s $ROOT/skills/humanize-korean $TMP_HOME/skills/humanize-korean"
...
assert_contains "$claude_desktop_output" "+ ln -s $ROOT/skills/humanize-korean $TMP_HOME/skills/humanize-korean"
